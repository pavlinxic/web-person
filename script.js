...
const btnDir = document.querySelector(".btn-dir-open");
const btnDirr = document.querySelector(".btn-dir-close");
const sectionActive = document.querySelector(".section--is-active");


btnDir.addEventListener("click", () => {
  sectionActive.style.overflowY = "scroll";
})



btnDirr.addEventListener("click", () => {
  sectionActive.style.overflowY = "hidden";
})
